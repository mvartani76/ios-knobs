...
public enum Knob2ControlType: Int, Codable {
...
@IBDesignable public class Knob2: UIControl {
    ...
    @IBInspectable public var minimumValue: Float = 0.0 { didSet { drawKnob2() }}
    
    /// The maximum value of the knob. Defaults to 1.0.
    @IBInspectable public var maximumValue: Float = 1.0 { didSet { drawKnob2() }}
    ...
    @IBInspectable public var baseColor: UIColor = .black { didSet { drawKnob2() }}
    
    /// Default color for the pointer. Defaults black.
    @IBInspectable public var pointerColor: UIColor = .black { didSet { drawKnob2() }}
    
    /// Default color for the progress. Defaults orange.
    @IBInspectable public var progressColor: UIColor = .orange { didSet { drawKnob2() }}
    
    /// Line width for the ring base. Defaults 2.
    @IBInspectable public var baseLineWidth: CGFloat = 2 { didSet { drawKnob2() }}
    
    /// Line width for the progress. Defaults 2.
    @IBInspectable public var progressLineWidth: CGFloat = 2 { didSet { drawKnob2() }}
    
    /// Line width for the pointer. Defaults 2.
    @IBInspectable public var pointerLineWidth: CGFloat = 2 { didSet { drawKnob2() }}
    ...
    public var controlType: Knob2ControlType = .rotary
    /// Knob gesture recognizer.
    public private(set) var gestureRecognizer: Knob2GestureRecognizer!
    ...
    private func commonInit() {
        // Setup knob gesture
        gestureRecognizer = Knob2GestureRecognizer(target: self, action: #selector(handleGesture(_:)))
    ...
    @objc dynamic func handleGesture(_ gesture: Knob2GestureRecognizer) {
...
public class Knob2GestureRecognizer: UIPanGestureRecognizer {
